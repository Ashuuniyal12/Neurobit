            ...
            {demmoData.channels.map((item) => {
                return (
                    <>
                        <Box
                            sx={{
                                height: "100px", width: "96%", backgroundColor: "white", borderRadius: "5px", alignItems: "center", justifyContent: "space-around", display: 'grid', borderRadius: "5px",
                        ...
                        <Box
                            sx={{
                                height: "100px", width: "96%", backgroundColor: "#F6F6F6", borderRadius: "5px", alignItems: "center", justifyContent: "center", display: 'grid', borderRadius: "5px",
