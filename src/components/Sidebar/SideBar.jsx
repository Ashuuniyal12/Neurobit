...
function ResponsiveDrawer(props) {
    ...
    const drawer = (
        <div style={{ color: 'white' }}>
            ...
            <Box sx={{ backgroundColor: "#02354F", width: "80%", height: "145px", right: "40px", textAlign: "center", alignItems: "center", display: "flex", flexDirection: "column", justifyContent: "center", bottom: '100px', position: "absolute" }}>
                <Typography sx={{ color: 'white', fontFamily: "DM Sans", fontSize: "28px", fontWeight: '500'}} >1,650</Typography>
                <Typography sx={{ color: 'white', fontFamily: "DM Sans", fontSize: "16px", fontWeight: '500'}} >Total Credits Available</Typography>
            </Box>
        </div >
    );
